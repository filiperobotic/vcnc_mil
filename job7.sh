...
#vcnc_kmeans30_confustion_aware_gatefilter_spatial_fixed + oamil_daniel_sched9mi (e4-off) - loc20%
python3 tools/train.py './custom_configs/daniel_oamil/faster-rcnn_r50_fpn_1x_voc_VCNC_gateOAMIL_loc20_schedule_9mile_e4on.py'  --work-dir ./work_dirs/vcnc_gate_e4off_oamil3x_daniel_sched9mi_loc20_run1;
python3 tools/train.py './custom_configs/daniel_oamil/faster-rcnn_r50_fpn_1x_voc_VCNC_gateOAMIL_loc20_schedule_9mile_e4on.py'  --work-dir ./work_dirs/vcnc_gate_e4off_oamil3x_daniel_sched9mi_loc20_run2;

#vcnc_kmeans30_confustion_aware_gatefilter_spatial_fixed + oamil_daniel_sched9mi (e4-off) - sim20%

python3 tools/train.py './custom_configs/daniel_oamil/faster-rcnn_r50_fpn_1x_voc_VCNC_gateOAMIL_sim20_schedule_9mile_e4off.py'  --work-dir ./work_dirs/vcnc_gate_e4off_oamil3x_daniel_sched9mi_sim20_run1;
python3 tools/train.py './custom_configs/daniel_oamil/faster-rcnn_r50_fpn_1x_voc_VCNC_gateOAMIL_sim20_schedule_9mile_e4off.py'  --work-dir ./work_dirs/vcnc_gate_e4off_oamil3x_daniel_sched9mi_sim20_run2;

#vcnc_kmeans30_confustion_aware_gatefilter_spatial_fixed + oamil_daniel_sched9mi (e4-off) - asym20%
python3 tools/train.py './custom_configs/daniel_oamil/faster-rcnn_r50_fpn_1x_voc_VCNC_gateOAMIL_asym20_schedule_9mile_e4off.py'  --work-dir ./work_dirs/vcnc_gate_e4off_oamil3x_daniel_sched9mi_asym20_run1;
