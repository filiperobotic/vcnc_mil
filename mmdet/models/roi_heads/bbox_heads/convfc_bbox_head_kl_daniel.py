...
from .bbox_head_kl_daniel import BBoxHeadKL


@MODELS.register_module()
class ConvFCBBoxHeadKL(BBoxHeadKL):
    ...
    def __init__(self,
                 ...
                 *args,
                 ...
                 var_sigma_t,
                 **kwargs) -> None:
        super(ConvFCBBoxHeadKL, self).__init__(*args, init_cfg=init_cfg, **kwargs)
        ...
        if self.with_reg:
            ...
            self.fc_reg_kl = MODELS.build(reg_predictor_cfg_)
        ...
        # inference params
        self.softnms = kwargs['softnms'] if 'softnms' in kwargs else True
        self.softnms_sigma = kwargs['softnms_sigma'] if 'softnms_sigma' in kwargs else 0.5
        self.var_vote = kwargs['var_vote'] if 'var_vote' in kwargs else True
...
@MODELS.register_module()
class Shared4Conv1FCBBoxHeadKL(ConvFCBBoxHeadKL):
