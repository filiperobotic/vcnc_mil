_base_ = [
    ...
    '../_base_/datasets/coco_detection_loc20.py',
...
custom_hooks = [
    ...
    dict(
        ...
        # === GATE v2 (COCO-safe) ===
        confusion_gate_severity='min',              # exige confusao reciproca
        confusion_gate_min_threshold=0.05,          # piso absoluto do threshold
        confusion_gate_ignore_zero_pairs=True,      # mediana/MAD so sobre sev > 0
