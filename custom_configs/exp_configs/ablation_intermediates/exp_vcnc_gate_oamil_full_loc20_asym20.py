...
# exp_oamil_voc_loc20_asym20.py schedule (OA-IS at epoch 2, OA-IE at epoch 9).
...
#
# === DATASET ===
# Inherits dataset from exp_oamil_voc_loc20_asym20.py (variant: loc20_asym20).

_base_ = ['./exp_oamil_voc_loc20_asym20.py']
