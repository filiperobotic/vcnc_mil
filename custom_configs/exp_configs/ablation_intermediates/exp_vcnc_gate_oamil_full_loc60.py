...
# exp_oamil_voc_loc60.py schedule (OA-IS at epoch 2, OA-IE at epoch 9).
...
#
# === DATASET ===
# Inherits dataset from exp_oamil_voc_loc60.py (variant: loc60).

_base_ = ['./exp_oamil_voc_loc60.py']
