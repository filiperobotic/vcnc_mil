...
# exp_oamil_voc_asym40.py schedule (OA-IS at epoch 2, OA-IE at epoch 9).
...
#
# === DATASET ===
# Inherits dataset from exp_oamil_voc_asym40.py (variant: asym40).

_base_ = ['./exp_oamil_voc_asym40.py']
