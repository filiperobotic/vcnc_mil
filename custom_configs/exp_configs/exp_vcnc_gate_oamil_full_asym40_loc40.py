...
# exp_oamil_voc_sim40.py schedule (OA-IS at epoch 2, OA-IE at epoch 9).
...
#
# === DATASET ===
# Defaults to sim40 via the OA-MIL production base. To switch noise
# variant, see the dataset note in exp_vcnc_gate_oamil_smoke.py or
# override via `--cfg-options`.

_base_ = ['./exp_oamil_voc_asym40_loc40.py']
